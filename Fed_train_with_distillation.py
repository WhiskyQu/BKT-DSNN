...
def federated_learning(model_class, trainloader, testloader, criterion, device, rounds, local_epochs,
    ...
    for round in range(rounds):
        ...
        for client_idx in selected_clients:
            ...
            teacher_model = global_model.to(device)
            train_model_with_distillation(client_models[client_idx], teacher_model, trainloader, criterion,
...
def main():
    ...
    if args.model_name in ['SNN_VGG9_BNTT', 'SNN_VGG11_BNTT', 'SNN_VGG9_BNTT_DCLS', 'SNN_VGG11_BNTT_DCLS']:
