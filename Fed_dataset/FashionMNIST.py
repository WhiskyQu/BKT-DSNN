...
class FashionMNISTNPYDataset(Dataset):
...
if __name__ == '__main__':
    train_images_path = '../data/FashionMNIST/npy/train_images.npy'
    train_labels_path = '../data/FashionMNIST/npy/train_labels.npy'

    dataset = FashionMNISTNPYDataset(train_images_path, train_labels_path, num_clients=5, add_noise=True, noise_level=0.2, non_iid=True)
